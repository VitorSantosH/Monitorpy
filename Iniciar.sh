...
echo "Verificando se o ambiente gráfico está disponível..."
while ! xhost &>/dev/null; do
    echo "Ambiente gráfico não acessível. Aguardando..."
    sleep 1
done
echo "Ambiente gráfico detectado. Continuando a execução."
...
python3 /home/sgtrack/Documentos/Monitorpy/index.py &
